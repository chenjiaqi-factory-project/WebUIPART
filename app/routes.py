...
from app.forms import GasDataRecordForm, SendCsvFileForm, GasDataStatsForm, WaterDataStatsForm,\
    ViewPanelSearchForm, WaterDataRecordForm
...
# stats panel
@app.route('/gas-stats-panel', methods=['GET', 'POST'])
def gas_stats_panel():
...
# status-panel version 2
# water stats panel
@app.route('/water-stats-panel', methods=['GET', 'POST'])
def water_stats_panel():
    ...
    if consumption_sum_dict['water_consumption_type'] == '错误' or\
        ...
        flash('数据统计成功!', 'success')
    # render templates
    return render_template('waterStatsPanel.html', consumption_sum_dict=consumption_sum_dict,
